...
public class HomeWorkActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPullToRefreshView.setAdapter(mHomeWorkAdapter);
	...
	class HomeWorkAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				viewHolder.isRead = (TextView) convertView
						.findViewById(R.id.is_read);
...
//						}
					...
					Toast.makeText(HomeWorkActivity.this, R.string.no_data,
