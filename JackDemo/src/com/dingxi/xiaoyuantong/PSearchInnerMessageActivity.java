...
public class PSearchInnerMessageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sreachConfirmButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(mStartData) ){
                    Toast.makeText(PSearchInnerMessageActivity.this, R.string.select_start_time,
                            Toast.LENGTH_LONG).show();
                }  else if(TextUtils.isEmpty(mEndData)){
                    Toast.makeText(PSearchInnerMessageActivity.this, R.string.select_end_time,
                            Toast.LENGTH_LONG).show();
                    
                }else {
                    Intent intent = new Intent(PSearchInnerMessageActivity.this, LeaveMessageActivity.class);
        ...
        sreachCancelButton.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                PSearchInnerMessageActivity.this.finish();
            }
        });
        ...
        selectTypeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               String typeNameList[] = {getString(R.string.search_type_all),getString(R.string.search_type_receiver),getString(R.string.search_type_sender)};;
                    AlertDialog.Builder builder = new AlertDialog.Builder(PSearchInnerMessageActivity.this);
        ...
        selectStartTimeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              mTimePickerDialog =  new DatePickerDialog(PSearchInnerMessageActivity.this, new OnDateSetListener() {
