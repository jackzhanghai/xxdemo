            ...
            public void onRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                if (Util.IsNetworkAvailable(LeaveMessageActivity.this)) {
                    ...
                    */
                    ...
                    Toast.makeText(LeaveMessageActivity.this, R.string.not_network, Toast.LENGTH_SHORT)
                            .show();
                }
...
// responseMessage.body = RestClient.getHomeWorks(curretUserInfo.id,curretUserInfo.ticket, curretUserInfo.roleType.toString(), info.toString(),curretPage, pageCount);
 //GetHomeWorTask(String userId,String sOrR,String startTime,String endTime,String roleId,String page,String rows)
            ...
            mPullToRefreshView.onRefreshComplete();
            Toast.makeText(LeaveMessageActivity.this, R.string.not_network, Toast.LENGTH_SHORT).show();
        }
    ...
    public class GetHomeWorTask extends AsyncTask<Void, Void, ResponseMessage> {
        ...
        protected ResponseMessage doInBackground(Void... params) {
            ...
            try {
                responseMessage.body =  RestClient.getLeaveMessages(userId, sOrR, startTime, endTime, roleId, ""+curretPage, rows);
            ...
            if (responseMessage.code == ResponseMessage.RESULT_TAG_SUCCESS) {
              ...
              // if (totalCount > 0) {
                ...
                */
                ...
                --curretPage;
                emptyView.setVisibility(View.VISIBLE);
                Toast.makeText(LeaveMessageActivity.this, responseMessage.message, Toast.LENGTH_LONG)
                        .show();
            }
